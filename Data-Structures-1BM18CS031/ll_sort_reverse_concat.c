...
void main(){
	...
	printf("Enter your choice:\n1:to insert in 1st list\n2:to insert in 2nd list\n3:to sort 1st list\n4:to reverse 1st list\n5:to concatinate 1st list with 2nd list\n6:to sort 2nd list\n7:to reverse 2nd list\n8:to display 1st list\n9:to display 2nd list\n10:to exit\n");
		scanf("%d", &ch);
